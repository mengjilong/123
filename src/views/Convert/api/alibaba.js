...
class AlibabaAPI {
	...
	static setAliKey(){
		...
		if(keyObj){ 
			...
			console.log('---------使用内部key----------')
			this.AccessKeyId = 'LTAI5tCmbGiyUaA6Xb2NDAjg：AccessKeyId';
			this.AccessKeySecret = '14msKt9EiWPPt98fjTW6qN78zWWw97：AccessKeySecret';
			this.appkey = 'Ot0TuNLmfOUHpMMZ：appkey';
